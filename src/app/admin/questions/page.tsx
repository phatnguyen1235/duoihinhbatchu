          ...
          <CardContent>
            <div className="grid md:grid-cols-3 gap-4">
              <div>
                ...
                />
                <p className="text-xs text-gray-500 mt-1">Thời gian cho mỗi câu hỏi</p>
              </div>
              <div>
                <label className="block text-sm font-medium mb-1">
                  Thời gian chờ phòng (giây)
                </label>
                <Input
                  type="number"
                  min="30"
                ...
                />
                <p className="text-xs text-gray-500 mt-1">Thời gian chờ trong lobby</p>
              </div>
              <div>
                <label className="block text-sm font-medium mb-1">
                ...
                />
                <p className="text-xs text-gray-500 mt-1">Mỗi người chơi sẽ trả lời bấy nhiêu câu</p>
              </div>
            </div>
            <Button 
              className="mt-4" 
                          ...
                          <tr key={code.id} className="border-t hover:bg-gray-50">
                            ...
                            <td className="px-2 py-1 text-center">
                              {code.playCount > 0 ? (
                                ...
                                <Badge variant="outline" className="text-green-600">Chưa dùng</Badge>
                              )}
                            </td>
